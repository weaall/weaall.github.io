...
export const Container = tw.div`flex flex-col w-full h-full mt-10 text-main pt-4 px-10 select-none
mobile:px-12`
...
export const MainLabel = tw.p`font-semibold text-main text-lg py-2 mobile:mx-auto`
