...
${(p) => (p.$state === true ? "w-[80%] px-6 duration-1000" : "w-14 duration-500")}
bg-main h-12 mx-2 flex relative rounded-3xl text-centerjustify-between transition-all ease-in`
...
min-w-auto w-full transition-all ease-in duration-100 text-center m-auto`
export const NavDirectP = tw(Link)`
hover:after:text-red-500 after:content-['.'] after:text-transparent mobile:text-[8px]`

export const SearchWrap = tw.div<NavStateProps>`
${(p) => (p.$state === true ? "w-14 duration-500" : "w-[80%] duration-1000")}
